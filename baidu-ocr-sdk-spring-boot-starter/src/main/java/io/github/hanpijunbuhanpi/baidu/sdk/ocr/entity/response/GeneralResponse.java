...
import io.github.hanpijunbuhanpi.baidu.sdk.ocr.entity.GeneralWords;
 ...
 */
@Data
public class GeneralResponse implements BaseBaiduResponse {
    /** 属性容器 */
    @JsonIgnore
    ...
    private List<GeneralWords> wordsResult;
