...
public class GlobalAllParamTest {
    ...
    @Autowired
    private BaiduImageSearch baiduImageSearch;
    @Autowired
    private BaiduKnowledgeGraphic baiduKnowledgeGraphic;
    @Autowired
    ...
    public void test() {
        ...
        Assert.isTrue(baiduBodyAnalysis != null, "Starter人体分析客户端未注册");
        // 内容审核
        ...
        Assert.isTrue(baiduContentCensor != null, "Starter内容审核客户端未注册");
        // EasyDL零门槛AI开发
        ...
        Assert.isTrue(baiduEasyDL != null, "Starter EasyDL客户端未注册");
        // 人脸识别
        ...
        Assert.isTrue(baiduFace != null, "Starter人脸识别客户端未注册");
        // 图像识别
        Assert.isTrue(imageClassifyConfigurationProperties != null, "图像识别属性未注入");
        Assert.isTrue(imageClassifyConfigurationProperties.getAppId().equals("111"), "图像识别app-id属性异常");
        Assert.isTrue(imageClassifyConfigurationProperties.getApiKey().equals("222"), "图像识别api-key属性异常");
        Assert.isTrue(imageClassifyConfigurationProperties.getSecretKey().equals("333"), "图像识别secret-key属性异常");
        Assert.isTrue(aipImageClassify != null, "图像识别客户端未注册");
        Assert.isTrue(baiduImageClassify != null, "Starter图像识别客户端未注册");
        // 图像增强
        Assert.isTrue(imageProcessConfigurationProperties != null, "图像增强属性未注入");
        Assert.isTrue(imageProcessConfigurationProperties.getAppId().equals("111"), "图像增强app-id属性异常");
        Assert.isTrue(imageProcessConfigurationProperties.getApiKey().equals("222"), "图像增强api-key属性异常");
        Assert.isTrue(imageProcessConfigurationProperties.getSecretKey().equals("333"), "图像增强secret-key属性异常");
        Assert.isTrue(aipImageProcess != null, "图像增强客户端未注册");
        Assert.isTrue(baiduImageProcess != null, "Starter图像增强客户端未注册");
        // 图像搜索
        ...
        Assert.isTrue(baiduImageSearch != null, "Starter图像搜索客户端未注册");
        // 知识图谱
        ...
        Assert.isTrue(baiduKnowledgeGraphic != null, "Starter知识图谱客户端未注册");
        // 机器翻译
        ...
        Assert.isTrue(baiduMachineTranslation != null, "Starter机器翻译客户端未注册");
        // 自然语言处理
        ...
        Assert.isTrue(baiduNlp != null, "Starter自然语言处理客户端未注册");
        // 文字识别
        ...
        Assert.isTrue(baiduOcr != null, "Starter文字识别客户端未注册");
        // 语音技术
        ...
        Assert.isTrue(baiduSpeech != null, "Starter语音技术客户端未注册");
    }
}
